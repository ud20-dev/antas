...
#OUT: "/tmp/096c8484d1d42f3ca41c4952b5eabd69bda0fd04508c03b87d58608d84089911/1783520643-24423"
*/ 
func GetPDFOutputPath(pdfPath string) (string, error) {
	...
	when := fmt.Sprintf("%d-%d", time.Now().Unix(), os.Getpid())
